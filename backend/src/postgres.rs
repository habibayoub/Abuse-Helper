...
const SCRIPTS_UP: [(&str, &str); 9] = [
    ...
    (
        "0008_update_tickets_analysis",
        include_str!("../migrations/0008_update_tickets_analysis.sql"),
    ),
    (
        "0009_add_foreign_key_constraint",
        include_str!("../migrations/0009_add_foreign_key_constraint.sql"),
    ),
];
